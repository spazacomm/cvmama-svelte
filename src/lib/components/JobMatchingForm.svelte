    ...
    {#if !success}
      ...
      <div class="text-center mb-12">
        ...
        <p class="text-lg text-gray-600 max-w-2xl mx-auto">
          Upload your current CV and the job description you're targeting. Our AI will analyze and tailor your CV to match the position perfectly.
        </p>
      </div>
    ...
    {:else}
      ...
      <div class="bg-white p-12 md:p-16 rounded-3xl shadow-xl border border-gray-100 text-center">
        ...
        <p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Your CV has been added to our processing queue. We'll analyze and optimize it to perfectly match the job description you provided.
        </p>
          ...
          <div class="flex items-start">
            ...
            <div class="text-left">
              ...
              <ul class="text-sm text-gray-700 space-y-2">
                ...
                <li class="flex items-start">
                  <span class="inline-block w-1.5 h-1.5 bg-[#F28C7A] rounded-full mr-2 mt-1.5"></span>
                  <span>You'll receive your optimized CV via email at <strong>{email}</strong></span>
                </li>
                <li class="flex items-start">
                  <span class="inline-block w-1.5 h-1.5 bg-[#F28C7A] rounded-full mr-2 mt-1.5"></span>
