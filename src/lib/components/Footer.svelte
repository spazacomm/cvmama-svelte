 ...
 <footer class="bg-[#1e293b] text-white py-12 ">
        <div class="max-w-6xl mx-auto px-6">
          ...
          />
                    ...
                    <p class="text-gray-400 mb-4 leading-relaxed">AI-powered job application optimization platform helping professionals land their dream jobs with tailored resumes and cover letters.</p>
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2025 CVMama. All rights reserved. Making job applications smarter with AI.</p>
            </div>
        </div>
    </footer>